...
const L = {
  ...
  , te = typeof Blob == "function" || typeof Blob < "u" && Object.prototype.toString.call(Blob) === "[object BlobConstructor]"
  ...
  , V = ({type: s, data: e}, t, n) => te && e instanceof Blob ? t ? n(e) : $(e, n) : se && (e instanceof ArrayBuffer || ne(e)) ? t ? n(e) : $(new Blob([e]), n) : n(d[s] + (e || ""))
  , $ = (s, e) => {
...
let S;
function ye(s, e) {
    if (te && s.data instanceof Blob)
        return s.data.arrayBuffer().then(Y).then(e);
    if (se && (s.data instanceof ArrayBuffer || ne(s.data)))
        return e(Y(s.data));
    V(s, !1, t => {
        S || (S = new TextEncoder),
        e(S.encode(t))
...
for (let s = 0; s < z.length; s++)
    E[z.charCodeAt(s)] = s;
const ge = s => {
    let e = s.length * .75, t = s.length, n, i = 0, r, o, h, a;
    s[s.length - 1] === "=" && (e--,
    s[s.length - 2] === "=" && e--);
    ...
    for (n = 0; n < t; n += 4)
        r = E[s.charCodeAt(n)],
        o = E[s.charCodeAt(n + 1)],
        h = E[s.charCodeAt(n + 2)],
        a = E[s.charCodeAt(n + 3)],
        y[i++] = r << 2 | o >> 4,
        y[i++] = (o & 15) << 4 | h >> 2,
        y[i++] = (h & 3) << 6 | a & 63;
    return g
            ...
            for (t.push(o); ; ) {
                if (n === 0) {
                    ...
                    if (k(t) < 8)
                        break;
                    const a = A(t, 8)
                      , g = new DataView(a.buffer,a.byteOffset,a.length)
                      , y = g.getUint32(0);
                    if (y > Math.pow(2, 21) - 1) {
                        h.enqueue(L);
                        break
                    }
                    i = y * Math.pow(2, 32) + g.getUint32(4),
                    n = 3
                } else {
                    if (k(t) < i)
                        break;
                    const a = A(t, i);
                    h.enqueue(F(r ? a : x.decode(a), e)),
                    n = 0
                }
                if (i === 0 || i > s) {
                    h.enqueue(L);
...
function ce(s, ...e) {
    return e.reduce( (t, n) => (s.hasOwnProperty(n) && (t[n] = s[n]),
    t), {})
}
const Ae = f.setTimeout
  , Te = f.clearTimeout;
function B(s, e) {
    e.useNativeTimers ? (s.setTimeoutFn = Ae.bind(f),
    s.clearTimeoutFn = Te.bind(f)) : (s.setTimeoutFn = f.setTimeout.bind(f),
    s.clearTimeoutFn = f.clearTimeout.bind(f))
}
const Re = 1.33;
function Oe(s) {
    return typeof s == "string" ? Ce(s) : Math.ceil((s.byteLength || s.size) * Re)
}
function Ce(s) {
    let e = 0
      , t = 0;
    for (let n = 0, i = s.length; n < i; n++)
        e = s.charCodeAt(n),
        e < 128 ? t += 1 : e < 2048 ? t += 2 : e < 55296 || e >= 57344 ? t += 3 : (n++,
        t += 4);
    return t
}
function Be(s) {
...
class M extends u {
    ...
    onError(e, t, n) {
        return super.emitReserved("error", new xe(e,t,n)),
        this
    }
    open() {
...
const ae = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split("")
  , P = 64
  , Ne = {};
let J = 0, T = 0, X;
function Q(s) {
...
class De extends M {
    ...
    onData(e) {
        ...
        ;
        ve(e, this.socket.binaryType).forEach(t),
    ...
    uri() {
        const e = this.opts.secure ? "https" : "http"
          , t = this.query || {};
        return this.opts.timestampRequests !== !1 && (t[this.opts.timestampParam] = he()),
...
class p extends u {
    ...
    create() {
        var e;
        const t = ce(this.opts, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
        t.xdomain = !!this.opts.xd;
        const n = this.xhr = new fe(t);
        try {
            ...
            n.onreadystatechange = () => {
                var i;
                n.readyState === 3 && ((i = this.opts.cookieJar) === null || i === void 0 || i.parseCookies(n)),
        ...
        typeof document < "u" && (this.index = p.requestsCount++,
    ...
    cleanup(e) {
        if (!(typeof this.xhr > "u" || this.xhr === null)) {
            if (this.xhr.onreadystatechange = Pe,
            e)
                try {
                    this.xhr.abort()
                } catch {}
            typeof document < "u" && delete p.requests[this.index],
            this.xhr = null
        }
    }
    onLoad() {
...
const H = typeof Promise == "function" && typeof Promise.resolve == "function" ? e => Promise.resolve().then(e) : (e, t) => t(e, 0)
  , R = f.WebSocket || f.MozWebSocket
  , j = !0
  , Ue = "arraybuffer"
  , Z = typeof navigator < "u" && typeof navigator.product == "string" && navigator.product.toLowerCase() === "reactnative";
class Ie extends M {
    constructor(e) {
        super(e),
    ...
    doOpen() {
        ...
        const e = this.uri()
          ...
          , n = Z ? {} : ce(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        this.opts.extraHeaders && (n.headers = this.opts.extraHeaders);
        try {
            this.ws = j && !Z ? t ? new R(e,t) : new R(e) : new R(e,t,n)
        } catch (i) {
...
const Fe = {
  ...
  , Me = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/
  , He = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
function q(s) {
    if (s.length > 2e3)
        throw "URI too long";
    const e = s
    ...
    for (; o--; )
        r[He[o]] = i[o] || "";
    return t != -1 && n != -1 && (r.source = e,
    r.host = r.host.substring(1, r.host.length - 1).replace(/;/g, ":"),
    r.authority = r.authority.replace("[", "").replace("]", "").replace(/;/g, ":"),
    r.ipv6uri = !0),
    r.pathNames = Ke(r, r.path),
    r.queryKey = We(r, r.query),
    r
}
function Ke(s, e) {
    const t = /\/{2,9}/g
      , n = e.replace(t, "/").split("/");
    return (e.slice(0, 1) == "/" || e.length === 0) && n.splice(0, 1),
...
let le = class b extends u {
    constructor(e, t={}) {
        ...
        t.port = e.port,
        e.query && (t.query = e.query)) : t.host && (t.hostname = q(t.host).host),
        B(this, t),
        ...
        typeof this.opts.query == "string" && (this.opts.query = Se(this.opts.query)),
        this.id = null,
        this.upgrades = null,
    ...
    setTransport(e) {
        this.transport && this.transport.removeAllListeners(),
        this.transport = e,
        e.on("drain", this.onDrain.bind(this)).on("packet", this.onPacket.bind(this)).on("error", this.onError.bind(this)).on("close", t => this.onClose("transport close", t))
    }
    probe(e) {
    ...
    onOpen() {
        ...
        b.priorWebsocketSuccess = this.transport.name === "websocket",
...
function $e(s, e="", t) {
    ...
    return n.id = n.protocol + "://" + r + ":" + n.port + e,
    n.href = n.protocol + "://" + r + (t && t.port === n.port ? "" : ":" + n.port),
    n
}
const Ye = typeof ArrayBuffer == "function"
  , ze = s => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(s) : s.buffer instanceof ArrayBuffer
  , pe = Object.prototype.toString
  , Je = typeof Blob == "function" || typeof Blob < "u" && pe.call(Blob) === "[object BlobConstructor]"
  , Xe = typeof File == "function" || typeof File < "u" && pe.call(File) === "[object FileConstructor]";
function K(s) {
    return Ye && (s instanceof ArrayBuffer || ze(s)) || Je && s instanceof Blob || Xe && s instanceof File
}
function C(s, e) {
...
function D(s, e) {
    ...
    if (K(s)) {
        ...
        const t = {};
        for (const n in s)
            Object.prototype.hasOwnProperty.call(s, n) && (t[n] = D(s[n], e));
        return t
    }
    return s
}
function Ge(s, e) {
    return s.data = U(s.data, e),
...
const je = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"]
  , Ze = 5;
var c;
(function(s) {
...
class W extends u {
    ...
    add(e) {
        ...
        if (typeof e == "string") {
            ...
            n || t.type === c.BINARY_ACK ? (t.type = n ? c.EVENT : c.ACK,
            this.reconstructor = new tt(t),
...
class tt {
    ...
    takeBinaryData(e) {
        ...
        this.buffers.length === this.reconPack.attachments) {
            const t = Ge(this.reconPack, this.buffers);
...
class de extends u {
    ...
    subEvents() {
        if (this.subs)
            return;
        const e = this.io;
        this.subs = [l(e, "open", this.onopen.bind(this)), l(e, "packet", this.onpacket.bind(this)), l(e, "error", this.onerror.bind(this)), l(e, "close", this.onclose.bind(this))]
    }
    get active() {
        return !!this.subs
    }
    ...
    _addToQueue(e) {
        ...
        e.push( (i, ...r) => n !== this._queue[0] ? void 0 : (i !== null ? n.tryCount > this._opts.retries && (this._queue.shift(),
        t && t(i)) : (this._queue.shift(),
        t && t(null, ...r)),
        n.pending = !1,
        this._drainQueue())),
        this._queue.push(n),
    ...
    onack(e) {
        ...
        typeof t == "function" && (t.apply(this, e.data),
...
class I extends u {
    constructor(e, t) {
        ...
        this.randomizationFactor((n = t.randomizationFactor) !== null && n !== void 0 ? n : .5),
        this.backoff = new w({
    ...
    open(e) {
        ...
        const i = l(t, "open", function() {
          ...
          , r = h => {
            ...
            e ? e(h) : this.maybeReconnectOnOpen()
        }
          , o = l(t, "error", r);
        if (this._timeout !== !1) {
    ...
    socket(e, t) {
        let n = this.nsps[e];
        return n ? this._autoConnect && !n.active && n.connect() : (n = new de(this,e,t),
        this.nsps[e] = n),
        n
    }
    _destroy(e) {
...
function N(s, e) {
    ...
    s = void 0),
    e = e || {};
    const t = $e(s, e.path || "/socket.io")
      , n = t.source
      , i = t.id
      , r = t.path
      , o = _[i] && r in _[i].nsps
      , h = e.forceNew || e["force new connection"] || e.multiplex === !1 || o;
    let a;
    return h ? a = new I(n,e) : (_[i] || (_[i] = new I(n,e)),
    a = _[i]),
